package com.joodang.order.service;
...
import com.joodang.order.dto.OrderHistDto;
import com.joodang.order.dto.OrderProductDto;
import com.joodang.order.entity.Order;
import com.joodang.order.entity.OrderProduct;
import com.joodang.order.repository.OrderRepository;
    ...
    public Page<OrderHistDto> getOrderList(String email, Pageable pageable){
        ...
        for(Order order : orders){
            ...
            for(OrderProduct orderProduct : orderProducts){
                ...
                ProductImg productImg = productImgRepository.findByProductIdAndRepImgYn(productId, "Y") ;
